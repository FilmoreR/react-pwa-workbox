...
- `firebase serve`Runs developmennt hosting[filmore-react-pwa]: Local server: http://localhost:5002
- `firebase deploy` Deploy production Hosting URL: https://filmore-react-pwa.web.app'
